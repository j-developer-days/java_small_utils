...
#mvn package --file ../pom.xml -U -X
rm -rfv ../temp_folder

mkdir -pv ../temp_folder/classes
mkdir -pv ../temp_folder/jar

javac -verbose -d ../temp_folder/classes/ -sourcepath ../src/main/java ../src/main/java/com/jdev/file/*.java ../src/main/java/com/jdev/logger/*.java ../src/main/java/com/jdev/util/*.java
