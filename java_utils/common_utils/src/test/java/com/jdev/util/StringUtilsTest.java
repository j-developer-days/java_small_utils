...
class StringUtilsTest {
    ...
    @ParameterizedTest
    void test_multipleCharByCount_withString(String text, int count, int expectedLength, int expectedMapSize,
                                             Map<String, Integer> expectedMap) {
        String s = StringUtils.multipleCharByCount(text, count);
