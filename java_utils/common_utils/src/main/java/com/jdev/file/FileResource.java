...
public class FileResource {
    ...
    public static File getFile(Class<?> aClass, String resourceName, boolean getParent) {
        return getFile((getParent ? aClass.getClassLoader().getParent() : aClass.getClassLoader()).getResource(resourceName).getFile(),
                "get resource by class name - '" + aClass.getCanonicalName() + "', resource name - " + resourceName + "\t get parent - " + getParent);
    }
