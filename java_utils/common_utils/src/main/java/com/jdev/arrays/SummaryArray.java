...
public abstract class SummaryArray implements ArrayInterface {
    ...
    public final void summary(int size) {
        ...
        ConsoleUtils.printToConsole("Sum = " + ArrayInterface.sum(arrayInts));
        ConsoleUtils.printToConsole("Average = " + ArrayInterface.average(arrayInts));
    }
